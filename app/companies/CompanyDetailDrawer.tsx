          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              {company.address && (company.address.city || company.address.country) && (
                <div className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-muted-foreground" />
                  <span>{company.address.city}, {company.address.state}, {company.address.country} {company.address.pincode}</span>
                </div>
              )}
                ...
                {company.address && (company.address.street || company.address.city || company.address.state || company.address.country || company.address.pincode) && (
                  <div>
                    ...
                    <div className="ml-4 mt-1">
                      ...
                      {company.address.pincode && <div>{company.address.pincode}</div>}
                    </div>
                  </div>
                )}
