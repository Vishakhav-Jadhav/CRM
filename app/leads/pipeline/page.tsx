...
export default function LeadPipelinePage() {
  ...
  const filtered = leads.filter((l: Lead) => {
    ...
    if (filter === 'about') {
      matchesFilter = ['Cold', 'Warm', 'Hot'].includes(l.lead_status);
    } else if (filter === 'closed') {
      matchesFilter = ['Won', 'Lost'].includes(l.lead_status);
    }
    ...
    // Company filter
    const matchesCompany = companyFilter === 'all' || l.company?.name === companyFilter;
